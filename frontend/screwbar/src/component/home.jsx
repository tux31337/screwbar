...
function Home() {
    ...
    const openModal = (postNumId) => {
        detailTeam = teams.filter((team) => 
            team.postNum === postNumId
        );
    ...
    return(
        ...
        <>
            ...
            <Modal open={modalOpen} close={closeModal} header="Modal heading" detail={detailTeam} >
                <div>
