...
function CreateTeam(props) {
  ...
  const postTeamPosting = () => {
    ...
    axios
      .post('/team/createTeam', formData, config)
      .then((result) => {
    ...
    <>
      <article className="createTeam">
        <section className="createTeam__form">
          ...
          <input
            type="file"
            className="createTeam__upload"
            onChange={handleChangeFile}
            multiple="multiple"
          />
        </section>
        <section className="createTeam__information">
          <span className="createTeam__information__title">
            카테고리/모임명
          </span>
          <span className="createTeam__information__excercise">
            <select
              onChange={excerciseTypeChange}
              className="createTeam__information__excercise__selectbox"
            >
          ...
          <input
            ...
            className="createTeam__information__subjectTitle"
            onChange={onTitle}
          />
          <span className="createTeam__information__information">정보</span>
          <span className="createTeam__information__name">
            이름 : {myInfo.userName}
          </span>
          <span className="createTeam__information__telephone">
            연락처 : {myInfo.phonenumber}
          </span>
          <span className="createTeam__information__subInformation">
            부가 정보
          </span>
          <span className="createTeam__information__open">
            공개 여부 :{' '}
            <input
              type="checkbox"
          ...
          <span className="createTeam__information__gender">
            성별 : {myInfo.gender}
          </span>
          <span className="createTeam__information__email">
            이메일 : {myInfo.email}
          </span>
          <span className="createTeam__information__age">
            나이 : {myInfo.age}
          </span>
          <span className="createTeam__information__detail">팀 세부 조건</span>
          <div className="createTeam__information__count">
            인원 :{' '}
            <input
              type="text"
              className="createTeam__information__count__input"
              onChange={personnelChange}
            ></input>
          </div>
          <span className="createTeam__information__pay">
            비용 :{' '}
            <input
              type="text"
              className="createTeam__information__pay__input"
              value={price}
              onChange={(event) =>
                setPrice(priceFormatChange(event.target.value))
              }
            ></input>
          </span>
          <span className="createTeam__information__date">
            날짜 :{' '}
            <input
              type="date"
              className="createTeam__information__date__input"
              onChange={dateChange}
            />
          </span>
          ...
          <select
            ...
            className="createTeam__information__temperatureChange"
          >
          ...
          <input
            type="date"
            className="createTeam__information__date__deadline1__input"
            onChange={deadline1}
          />
          <input
            type="time"
            className="createTeam__information__date__deadline2__input"
            onChange={deadline2}
          />
          <span className="createTeam__information__area">
            지역설정 :&nbsp;
            <select
              className="createTeam__information__area__value"
          ...
          <button onClick={postTeamPosting} className="createTeam__postBtn">
            글작성
          </button>
        </section>
      </article>
